...
def criar_matriz_distancia(coordenadas):
    n = len(coordenadas)
...
if __name__ == "__main__":
    ...
    matriz_distancias = criar_matriz_distancia(coordenadas)
    
    print(matriz_distancias)

    np.random.seed(42)
    algoritmo = AlgoritmoGenetico(matriz_distancias=matriz_distancias, n_individuos=500, taxa_mutacao=0.1, n_geracoes=1500)
    algoritmo.evoluir()
